...
class Xtra_Elementor_Widget_menu extends Widget_Base {
	...
	public function render() {
		...
		echo '<i class="' . esc_attr( ( empty( $settings['search_icon'][ 'value' ] ) ? 'fa fa-bars' : $settings['search_icon'][ 'value' ] ) . ' icon_mobile_' . $type . $menu_icon_class ) . '"><span>' . esc_html( $menu_title ) . '</span></i>';
