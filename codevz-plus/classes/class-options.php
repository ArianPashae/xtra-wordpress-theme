...
::-moz-selection {background-color: ' . $site_color . ';color: #fff}';
		...
		if ( $i ) {
			...
			return array(
				array(
					...
					'type' 			=> 'codevz_image_select',
					'title' 		=> esc_html__( 'Header position', 'codevz' ),
					'help' 			=> esc_html__( 'Header position according to the page title and breadcrumbs.', 'codevz' ),
					'options' 		=> [
	...
	public static function options( $all = false ) {
		...
		$custom_stylekits[] = array(
			...
			'desc' 			=> $free ? '' : esc_html__( 'Save and refresh is required', 'codevz' ),
			'content' 		=> Codevz_Plus::pro_badge(),
				...
				array(
					...
					'fields' => array(
						...
						array(
							'id'        => 'site_width',
							'type'      => 'slider',
							'help' 		=> esc_html__( 'Site width allows any type of units such as px, %, em', 'codevz' ),
						...
						array(
							...
							'help' 			=> esc_html__( 'Keep desktop layout on all the small devices.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge()
						),
						array(
							'id' 			=> 'sticky',
							...
							'help' 			=> esc_html__( 'Sticky sidebar is a sidebar that’s locked into place, so when a user scrolls down the page, it doesn’t disappear.', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge()
						),
						array(
							'id'            => 'rtl',
				...
				array(
					...
					'fields' => wp_parse_args( $custom_stylekits, array(
						...
						array(
							...
							'selector' 		=> '.widget > h4, .sidebar_inner .widget_block > div > div > h2'
						),
						array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'margin', 'width', 'height', 'border', 'top', 'left', 'bottom', 'right' ),
							'selector' 		=> '.widget > h4:before, .sidebar_inner .widget_block > div > div > h2:before'
						),
						array(
						...
						array(
							...
							'selector' 		=> '.widget > h4:after, .sidebar_inner .widget_block > div > div > h2:after'
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help' 		=> esc_html__( 'In which post type do you want social share icons to be displayed?', 'codevz' ),
						...
						array(
							...
							'type' 		=> 'checkbox',
							'title' 	=> esc_html__( 'Share icons', 'codevz' ),
							'help' 		=> esc_html__( 'Which social share icons you want to be displayed?', 'codevz' ),
							'options' 	=> array(
						...
						array(
							...
							'help' 		=> esc_html__( 'Social media original colors', 'codevz' ),
							'options' 	=> array(
				...
				array(
					...
					'fields' => array(
						array(
							...
							'help' 			=> esc_html__( 'Page title tag in Title and Breadcrumbs section.', 'codevz' ),
							'options' 		=> array(
								'' 				=> 'H1',
								'h2' 			=> 'H2',
								'h3' 			=> 'H3',
				...
				array(
					...
					'fields' => array(
						array(
							...
							'type'			=> 'switcher',
							'title'			=> esc_html__( 'Loading', 'codevz' ),
							'help'			=> esc_html__( 'Once the content of the page is loaded, we’ll animate the preloading screen away from the viewport with a nice transition.', 'codevz' ),
						),
						array(
							'id' 			=> 'loading_out_fx',
							'type' 			=> $free ? 'content' : 'select',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help'          => esc_html__( 'Any type of image is allowed', 'codevz' ),
							'content' 		=> Codevz_Plus::pro_badge(),
							'setting_args'  => [ 'transport' => 'postMessage' ],
				...
				array(
					...
					'fields' => array(
						array(
							...
							'help' 		=> esc_html__( 'Create a template or page and assing it as custom template here.', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages
						),
						array(
							'id'    	=> 'header_mobile_elementor',
							'type'  	=> 'select',
							'title' 	=> esc_html__( 'Tablet & mobile header', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages
						),
					),
				),
				...
				array(
					...
					'fields' => [
						...
						array(
							...
							'help' 		=> esc_html__( 'Fixed navigation bar allow the visitor to access the main site links very quickly and it will always visible at bottom of page.', 'codevz' ),
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type'  	=> 'select',
							'title' 	=> esc_html__( 'Tablet & mobile Footer', 'codevz' ),
							'options' 	=> Codevz_Plus::$array_pages
						),
					),
				),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'selector' 		=> '.footer_widget > h4, footer .widget_block > div > div > h2',
							'dependency' 	=> array( 'footer_layout', '!=', '' )
						),
						array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'margin', 'width', 'height', 'border', 'top', 'left', 'bottom', 'right' ),
							'selector' 		=> '.footer_widget > h4:before, footer .widget_block > div > div > h2:before',
							'dependency' 	=> array( 'footer_layout', '!=', '' )
						),
						array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'margin', 'width', 'height', 'border', 'top', 'left', 'bottom', 'right' ),
							'selector' 		=> '.footer_widget > h4:after, footer .widget_block > div > div > h2:after',
							'dependency' 	=> array( 'footer_layout', '!=', '' )
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'help' 			=> esc_html__( 'Make your posts thumbnail bigger than current size.', 'codevz' ),
						...
						array(
							...
							'help' 			=> esc_html__('Showing SVG cover for posts that does not have a featured image.', 'codevz'),
							'dependency' 	=> array( 'template_style', '!=', 'x' ),
						),
						array(
							'id'    		=> 'post_excerpt',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
							'title' 		=> esc_html__( 'More icon', 'codevz' ),
							'button' 		=> esc_html__( 'More icon', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'font-size' ),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'background', 'font-size', 'border' ),
							'selector' 		=> '.tagcloud a, .widget .tagcloud a, .cz_post_cat a'
						),
						array(
						...
						array(
							...
							'type' 			=> 'cz_sk_hidden',
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'selector' 		=> '.tagcloud a:hover, .widget .tagcloud a:hover, .cz_post_cat a:hover'
						),
						array(
						...
						'fields' => wp_parse_args(
							array(
								...
								array(
									...
									'help' 			=> esc_html__( 'You can add and edit Wishlist page from Dashboard > Pages and include wishlist shortcode [cz_wishlist] in page content.', 'codevz' ),
									'options' 		=> Codevz_Plus::$array_pages,
									'default' 		=> 'Wishlist',
								...
								array(
									...
									'type'  		=> 'switcher',
									'title' 		=> esc_html__( 'Center Mode', 'codevz' ),
									'help' 			=> esc_html__( 'Move wishlist and quick view icons to the center of products.', 'codevz' )
								),
								array(
									'id'    		=> 'woo_cart',
									'type'  		=> 'text',
								...
								array(
									...
									'default' 		=> esc_html__( 'No products in the cart', 'codevz' ),
									'setting_args' 	=> [ 'transport' => 'postMessage' ],
								),
							),
			...
			'fields'          => array(
				...
				array(
					...
					'options' => array(
						...
						'wishlist'  => esc_html__( 'Wishlist', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				...
				[
					...
					'dependency' => $free ? [ 'element', 'any', 'logo_2,wishlist,wpml,avatar,custom,custom_element' ] : [ 'xxx', '==', 'xxx' ],
				],
				...
				array(
					...
					'type'  		=> 'icon',
					'title' 		=> esc_html__( 'Icon', 'codevz' ),
					'dependency' => array( 'element', 'any', $free ? 'shop_cart' : 'shop_cart,wishlist' ),
				),
				array(
					'id'    	=> 'shopcart_title',
					'type'  	=> 'text',
